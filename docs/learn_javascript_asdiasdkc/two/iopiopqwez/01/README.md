...
现在让我们继续。假设我们要从服务器动态获取资料。我们将 [在后续章节](../../../three/qeiwoquweiz/01/README.md) 中学习进行此操作的方法。目前，只需要关心我们从网络服务器获取 HTML 文章并按需显示：
...
<ClientOnly>
  <learn_javascript_asdiasdkc-two-iopiopqwez-01-demo1 />
</ClientOnly>
...
观察器在内部对节点使用所谓的“弱链接”指向要查找的节点。也就是说，如果一个节点被从 DOM 中移除了，并且该节点变得不可访问，则无论是否有观察者，都将从内存中将其删除，将其进行垃圾回收。
:::

...
- 请求以 POST 方式发送。
- 我们不仅能发送字符串，还能发送表单以及其他格式的数据，在 [Fetch](../../../three/qeiwoquweiz/01/README.md) 一章有详细讲解，但通常它是一个字符串化的对象。
- 数据大小限制在 64kb。

当 `sendBeacon` 请求完成时，浏览器可能已经离开了文档，所以就无法获取服务器响应（对于分析数据来说通常为空）。

还有一个 `keep-alive` 标志，该标志用于在 [fetch](../../../three/qeiwoquweiz/01/README.md) 方法中为通用的网络请求执行此类“离开页面后”的请求。你可以在 [Fetch API](../../../three/qeiwoquweiz/06/README.md) 一章中找到更多相关信息。
...
此示例运行 在 [sandbox](https://plnkr.co/edit/ct5SNvrHCA75b2KZ?p=preview&preview) 中。

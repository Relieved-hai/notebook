...
- `node.replaceWith(...nodes or strings)` —— 将 `node` **替换** 为给定的节点或字符串。
...
![](./images/before-prepend-append-after.svg)
...
我们之所以提到 `DocumentFragment`，主要是因为它上面有一些概念，例如 [template](../../../three/quwioenzskjd/04/README.md) 元素，我们将在以后讨论。

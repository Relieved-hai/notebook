...
![](./images/metric-offset-parent.svg)
...
![](./images/metric-offset-width-height.svg)
...
![](./images/metric-client-left-top.svg)
...
![](./images/metric-client-left-top-rtl.svg)
...
![](./images/metric-client-width-height.svg)
...
![](./images/metric-client-width-nopadding.svg)
...
![](./images/metric-scroll-width-height.svg)
...
但是，正如我们在 [样式和类](../../xkcopvjksern/08/README.md) 一章所知道的那样，我们可以使用 `getComputedStyle` 来读取 CSS-width 和 height。

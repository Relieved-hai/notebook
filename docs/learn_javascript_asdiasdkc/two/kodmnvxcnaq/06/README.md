...
<p>Current scroll = <b id="showScrollDemo">0px</b></p>
...
但是我们可以在导致滚动的事件上，例如在 <kbd>pageUp</kbd> 和 <kbd>pageDown</kbd> 的 `keydown` 事件上，使用 `event.preventDefault()` 来阻止滚动。
...
<ClientOnly>
  <learn_javascript_asdiasdkc-two-kodmnvxcnaq-06-example1 />
</ClientOnly>

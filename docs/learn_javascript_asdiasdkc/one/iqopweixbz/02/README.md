...
![](./images/rabbit-animal-independent-animal.svg)
...
![](./images/animal-rabbit-extends.svg)
...
我们可以回忆一下 [原生的原型](../../ghdfgqowei/03/README.md) 这一章的内容，JavaScript 内建对象同样也使用原型继承。例如，`Date.prototype.[[Prototype]]` 是 `Object.prototype`。这就是为什么日期可以访问通用对象的方法。
...
正如我们在 [深入理解箭头函数](../../uweiqowjsa/11/README.md) 一章中所提到的，箭头函数没有 `super`。
...
根据 [规范](https://tc39.es/ecma262/#sec-runtime-semantics-classdefinitionevaluation)，如果一个类扩展了另一个类并且没有 `constructor`，那么将生成下面这样的“空” `constructor`：
...
![](./images/super-homeobject-wrong.svg)

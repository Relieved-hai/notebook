...
更多内容：[现代模式，"use strict"](../../cvdfsdreew/02/README.md)。
...
更多内容：[变量](../../cvdfsdreew/03/README.md) 和 [数据类型](../../cvdfsdreew/04/README.md)。
...
[confirm(question)](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/confirm)

提出一个问题，并建议用户在“确定”和“取消”之间进行选择。选择结果以 `true/false` 形式返回。

<br/>

[alert(message)](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/alert)
...
更多内容：[交互：alert、prompt 和 confirm](../../cvdfsdreew/05/README.md)。
...
按位运算符在最低位级上操作 32 位的整数：详见 [文档](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Expressions_and_Operators#Bitwise)。
...
更多内容：[基础运算符，数学](../../cvdfsdreew/07/README.md)，[值的比较](../../cvdfsdreew/08/README.md)，[逻辑运算符](../../cvdfsdreew/11/README.md)，[空值合并运算符 '??'](../../cvdfsdreew/12/README.md)。
...
更多内容：[循环：while 和 for](../../cvdfsdreew/13/README.md)。
...
详情请见：["switch" 语句](../../cvdfsdreew/14/README.md)。
...
详细内容：请见 [函数](../../cvdfsdreew/15/README.md)，[箭头函数，基础知识](../../cvdfsdreew/17/README.md)。

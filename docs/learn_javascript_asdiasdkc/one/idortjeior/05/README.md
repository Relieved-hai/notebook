...
This is a recent addition to the language. You can find the current state of support at [https://caniuse.com/#feat=bigint](https://caniuse.com/#feat=bigint).
:::
...
[MDN 文档对 BigInt 的介绍](https://developer.mozilla.org/zh-CN/docs/Web/Web/JavaScript/Reference/Global_Objects/BigInt)。

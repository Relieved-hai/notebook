...
正如我们在 [数据类型](../../cvdfsdreew/04/README.md) 一章学到的，JavaScript 中有八种数据类型。有七种原始类型，因为它们的值只包含一种东西（字符串，数字或者其他）。
...
![](./images/object-user-isadmin.svg)
...
有另一种将对象属性变为常量的方式，我们将在后面的 [属性标志和属性描述符](../../mncmvneqwe/01/README.md) 一章中学习它。
:::
...
我们将在 [后续章节](../../ghdfgqowei/01/README.md) 中学习 __proto__ 的特殊性质，并给出了 [解决此问题的方法](../../ghdfgqowei/04/README.md)。

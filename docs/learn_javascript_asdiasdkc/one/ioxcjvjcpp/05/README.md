...
[类](../../iqopweixbz/01/README.md) 是用于创建复杂对象的一个更高级的语法，我们稍后会讲到。
...
- 造函数只能使用 `new` 来调用。这样的调用意味着在开始时创建了空的 `this`，并在最后返回填充了值的 `this`。
...
在我们学习了那些之后，我们将回到对象，在 [原型，继承](../../ghdfgqowei/01/README.md) 和 [类](../../iqopweixbz/01/README.md) 章节中深入介绍它们。
:::

...
![](./images/variable-copy-value.svg)
...
![](./images/variable-contains-reference.svg)
...
![](./images/variable-copy-reference.svg)
...
我们可以用递归来实现。或者不自己造轮子，使用现成的实现，例如 JavaScript 库 [lodash](https://lodash.com/) 中的 [_.cloneDeep(obj)](https://lodash.com/docs/4.17.15#cloneDeep)，或者 [Ramda](https://ramda.cn/)
...
为了创建“真正的拷贝”（一个克隆），我们可以使用 `Object.assign` 来做所谓的“浅拷贝”（嵌套对象被通过引用进行拷贝）或者使用“深拷贝”函数，例如 [_.cloneDeep(obj)](https://lodash.com/docs/4.17.15#cloneDeep)。

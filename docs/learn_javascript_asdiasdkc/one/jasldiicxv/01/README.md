...
正如我们所知道的，JavaScript 支持 [JSON.parse(str)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/JSON/parse) 方法来解析 JSON 编码的值。
...
你可以在 [JSON 方法，toJSON](../../wergfhgfhk/12/README.md) 一章中找到更多关于 JSON 的详细内容。

...
![](./images/native-prototypes-classes.svg)
...
![](./images/native-prototypes-array-tostring.svg)
...
在 [装饰器模式和转发，call/apply](../../uweiqowjsa/09/README.md#借用一种方法) 一章中，我们讨论了方法借用。

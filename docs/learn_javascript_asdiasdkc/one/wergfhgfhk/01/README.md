...
例如，字符串方法 [str.toUpperCase()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/toUpperCase) 返回一个大写化处理的字符串。
...
我们将在后面 [数字类型](../../wergfhgfhk/02/README.md) 和 [字符串](../../wergfhgfhk/03/README.md) 章节中看到更多具体的方法。

...
- 在 Chrome 中打开 [示例页面](/learn_javascript_asdiasdkc/one/uiooxcvasj/01/example/index.html)。
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-172px -98px'
                                                     beforeText='切换按钮'
                                                     afterText='会打开文件列表的选项卡。'/>
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-172px -122px'
                                                     beforeText='现在你可以再次点击切换按钮'
                                                     afterText='隐藏资源列表来给代码腾出一些空间。'/>
...
我们来看看 [示例页面](/learn_javascript_asdiasdkc/one/uiooxcvasj/01/example/index.html) 发生了什么。在 `hello.js` 中，点击第 `4` 行。是的，就点击数字 `"4"` 上，不是点击代码。
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-146px -171px'
                                                     afterText=' “恢复（Resume）”：继续执行，快捷键 F8。'/>
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-200px -196px'
                                                     afterText=' “下一步（Step）”：运行下一条指令，快捷键 F9。'/>
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-62px -196px'
                                                     afterText='  “跨步（Step over）”：运行下一条指令，但 不会进入到一个函数中，快捷键 F10。'/>
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-4px -195px'
                                                     afterText=' “步入（Step into）”，快捷键 F11。'/>
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-32px -195px'
                                                     afterText=' “步出（Step out）”：继续执行到当前函数的末尾，快捷键 Shift+F11。'/>

<br/>

<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-200px -194px'
                                                     fontWeight='initial'
                                                     beforeText='继续执行代码并停止在当前函数的最后一行。当我们使用 '
                                                     afterText=' 偶然地进入到一个嵌套调用，但是我们又对这个函数不感兴趣时，我们想要尽可能的继续执行到最后的时候是非常方便的。'/>

<br/>
<br/>

<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-61px -74px'
                                                     afterText=' 启用/禁用所有的断点。'/>
...
<learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-90px -147px'
                                                     afterText=' 启用/禁用出现错误时自动暂停脚本执行。'/>
...
1. 一个断点。
2. debugger 语句。
3. <learn_javascript_asdiasdkc-one-uiooxcvasj-01-bgIcon bgPos='-90px -147px'
                                                     fontWeight='initial'
                                                     beforeText='一个错误（如果开发者工具是打开状态，并且按钮 '
                                                     afterText=' 是开启的状态）。'/>

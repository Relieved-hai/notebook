...
JavaScript 语言在稳步发展。也会定期出现一些对语言的新提议，它们会被分析讨论，如果认为有价值，就会被加入到 [https://tc39.github.io/ecma262/](https://tc39.github.io/ecma262/) 的列表中，然后被加到 [规范](https://www.ecma-international.org/publications-and-standards/standards/ecma-262/) 中。

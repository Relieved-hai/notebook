...
[Open the example in the sandbox.](https://plnkr.co/edit/GbnfZaiQjI09SIgj?p=preview&preview)
...
`pow` 的基础功能已经完成了。第一次迭代开发完成啦。让我们继续改进它吧。
...
在 [Chai](https://www.chaijs.com/) 中也有其他的断言，例如：
...
- ……完整的列表请见 [docs](https://www.chaijs.com/api/assert/)
:::
...
[Open the full final example in the sandbox.](https://plnkr.co/edit/d9iXyHLaB8ZB5b2x?p=preview&preview)
...
在后面部分，你将遇到许多包含了测试的任务。所以你会看到更多的实际例子。

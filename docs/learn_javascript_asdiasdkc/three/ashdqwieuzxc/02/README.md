...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo1 />
</ClientOnly>
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo2 />
</ClientOnly>
...
不是所有的 CSS 属性都可以使用过渡动画，但是它们中的[大多数](http://w3.org/TR/css3-transitions/#animatable-properties-)都是可以的。`all` 表示应用在所有属性上。
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo3 />
</ClientOnly>
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo4 />
</ClientOnly>
...
时间函数可以用[贝塞尔曲线](../../ashdqwieuzxc/01/README.md)描述，通过设置四个满足以下条件的控制点：
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo5 />
</ClientOnly>
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo6 />
</ClientOnly>
...
| ![](./images/ease.svg) | ![](./images/ease-in.svg) | ![](./images/ease-out.svg) | ![](./images/ease-in-out.svg) |
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo7 />
</ClientOnly>

为什么会这样？看一眼给定的贝塞尔曲线的图像你就会明白了。

![](./images/bezier-train-over.svg)
...
但是，如何针对特定的任务寻找到合适的贝塞尔曲线呢？事实上，有很多工具可以帮到你。比方说，我们可以利用这个网站：[http://cubic-bezier.com/](http://cubic-bezier.com/)。
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo8 />
</ClientOnly>
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo9 />
</ClientOnly>
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo10 />
</ClientOnly>
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-ashdqwieuzxc-02-demo11 />
</ClientOnly>

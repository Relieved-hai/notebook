...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-qeiwoquweiz-10-code1 />
</ClientOnly>

<ClientOnly>
  <learn_javascript_asdiasdkc-three-qeiwoquweiz-10-code2 />
</ClientOnly>
...
因此，在这种情况下，首选另一种方法，例如：[Websocket](../../qeiwoquweiz/11/README.md) 或 [Server Sent Events](../../qeiwoquweiz/12/README.md) 。

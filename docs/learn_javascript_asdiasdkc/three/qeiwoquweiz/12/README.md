...
```js
let source = new EventSource("https://site.com/events");
```
...
更多关于跨源 header 的详细内容，请参见 [Fetch：跨源请求](../../qeiwoquweiz/05/README.md) 。
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-qeiwoquweiz-12-code1 />
</ClientOnly>

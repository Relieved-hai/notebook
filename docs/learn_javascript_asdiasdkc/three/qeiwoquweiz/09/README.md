...
对于大文件（如果我们可能需要恢复），可恢复的上传应该带有上传进度提示。由于 `fetch` 不允许跟踪上传进度，我们将会使用 [XMLHttpRequest](../../qeiwoquweiz/08/README.md) 。
...
<ClientOnly>
  <learn_javascript_asdiasdkc-three-qeiwoquweiz-09-code1 />
</ClientOnly>

<ClientOnly>
  <learn_javascript_asdiasdkc-three-qeiwoquweiz-09-code2 />
</ClientOnly>

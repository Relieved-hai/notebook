<template>
  <body class="h-b" id="bodydom" style="height: 450px; overflow-y: scroll;">
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      function isVisible(elem) {
        ...
        let windowHeight = document.getElementById('bodydom').clientHeight;
      ...
      document.getElementById('bodydom').addEventListener('scroll', showVisible);
      showVisible();
    })
  }
}
